...
namespace vv.Domain.Services
{
    ...
    public interface IMarketDataService
    {
        ...
        Task<decimal> GetLatestMidRateAsync(string baseCurrency, string quoteCurrency);

        Task<IEnumerable<FxSpotPriceData>> GetHistoricalPricesAsync(string assetId, DateOnly fromDate, DateOnly toDate);

        Task<decimal> CalculatePriceVolatilityAsync(string assetId, int days);
